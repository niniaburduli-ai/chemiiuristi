...
const ka = {
  ...
  profile: {
    ...
    viewHistoryCta: "წინა ისტორიების ნახვა",
    consultationsHistoryHint: "თქვენი წარსული კითხვები და AI პასუხები",
    reviewsHistoryHint: "ატვირთული დოკუმენტების ანალიზის შედეგები",
    documentsHistoryHint: "თქვენ მიერ გენერირებული დოკუმენტები",
    templatesHistoryHint: "თქვენ მიერ შევსებული მზა შაბლონები",
...
const en: Dict = {
  ...
  profile: {
    ...
    viewHistoryCta: "View previous history",
    consultationsHistoryHint: "Your past questions and AI answers",
    reviewsHistoryHint: "Analysis results of your uploaded documents",
    documentsHistoryHint: "Documents generated by you",
    templatesHistoryHint: "Ready-made templates you've filled",
