...
const ka = {
  ...
  pricing: {
    ...
    customSubtitle: "აირჩიე სასურველი სერვისი და რაოდენობა.",
    ...
    customMinAmount: "აირჩიე სულ მცირე 5 ლარის სერვისი",
  ...
  documentAnalysis: {
    ...
    dropzoneHint: "ატვირთე დოკუმენტი (PDF, DOCX, TXT, MD, JPG, PNG)",
    pageCreditNotice:
  ...
  servicesModal: {
    ...
    templatesHint: "შეავსე მზა შაბლონი მყისიერად",
  ...
  generatePage: {
    ...
    customNotice: "აღწერე დოკუმენტი, რომელიც გჭირდება — AI თავად განსაზღვრავს დოკუმენტის ტიპს და საქართველოს კანონმდებლობით სავალდებულო ელემენტებს.",
    cardTitle: "დოკუმენტის ტიპი და დეტალები",
    cardSubtitle: "აირჩიე ტიპი და შეავსე დეტალები",
    docTypeLabel: "დოკუმენტის ტიპი",
    extraLabel: "დამატებითი დეტალები",
    extraPlaceholder: "დაამატე ნებისმიერი სხვა მნიშვნელოვანი დეტალი",
    customExtraLabel: "აღწერე საჭირო დოკუმენტი",
    customExtraPlaceholder: "დეტალურად აღწერე, რა დოკუმენტი გჭირდება და რა პირობები უნდა ჩაერთოს მასში",
