...
const ka = {
  ...
  pricing: {
    ...
    subtitle: "აირჩიეთ მზა პაკეტი ან შექმენით თქვენი საკუთარი.",
    popular: "ყველაზე პოპულარული",
    perMonth: "თვეში",
    join: "აირჩიეთ პაკეტი",
    start: "დაიწყეთ უფასოდ",
    customTitle: "შექმენით საკუთარი პაკეტი",
    customSubtitle: "აირჩიეთ სასურველი სერვისი და რაოდენობა.",
    ...
    customMinAmount: "აირჩიეთ სულ მცირე 5 ლარის სერვისი",
  ...
  home: {
    ...
    testimonialsHeading: "რას ფიქრობენ ჩვენზე",
  },
  chat: {
  ...
  dashboard: {
    ...
    upgradeCta: "გადადით სტანდარტ გეგმაზე",
  ...
  billing: {
    ...
    activeSub: "აქტიური გამოწერა",
    freePlanLabel: "უფასო გეგმა",
    nextPayment: "შემდეგი გადახდა:",
    changePlan: "გეგმის შეცვლა",
    choosePlan: "გეგმის არჩევა",
    cancelSub: "გამოწერის გაუქმება",
    confirmCancel: "ნამდვილად გსურთ გამოწერის გაუქმება?",
  ...
  profile: {
    ...
    upgradeTitle: "განაახლეთ სტანდარტ გეგმაზე",
    ...
    viewAll: "ყველა",
    noConsultations: "ჯერ კონსულტაცია არ გაქვთ.",
    startChat: "დაიწყეთ",
    noDocs: "ჯერ დოკუმენტი არ შექმნილა.",
    createDoc: "შექმენით",
    noReviews: "ჯერ ანალიზი არ გაქვთ.",
    uploadDoc: "ატვირთეთ",
    noTemplates: "ჯერ შაბლონი არ შეგივსიათ.",
  ...
  documentAnalysis: {
    ...
    subtitle: "AI აანალიზებს რისკებს კატეგორიების მიხედვით, გაძლევთ რეკომენდაციებს და შეგისწორებთ დოკუმენტს სურვილის შემთხვევაში.",
    disclaimer:
    ...
    dropzoneHint: "ატვირთეთ დოკუმენტი (PDF, DOCX, TXT, MD, JPG, PNG)",
    pageCreditNotice:
    ...
    unsupportedTypeError: "მხარდაუჭერელი ფაილის ტიპი — PDF, DOCX, TXT, MD, JPG ან PNG",
    ...
    improveOptionalHint: "სურვილის შემთხვევაში AI-ს დახმარებით შეგიძლიათ გააუმჯობესოთ დოკუმენტი.",
    stepContinueToFixCta: "გადავიდეთ შესწორებაზე",
    stepFinishCta: "დასრულება",
  ...
  servicesModal: {
    ...
    templatesHint: "შეავსეთ მზა შაბლონი მყისიერად",
    customDocsTab: "დოკუმენტის მომზადება",
    customDocsHint: "AI ადგენს საჩივარს, მოთხოვნას ან ნებისმიერ სხვა დოკუმენტს თქვენი სიტუაციის მიხედვით",
  ...
  generatePage: {
    ...
    pageSubtitle: "AI ადგენს საჩივარს, მოთხოვნას ან ნებისმიერ სხვა დოკუმენტს თქვენი კონკრეტული სიტუაციის მიხედვით",
    ...
    demandNotice: "გაითვალისწინეთ: სამართლებრივი მოთხოვნა გამოიყენება მესამე პირის მიმართ ოფიციალური პრეტენზიის წარსადგენად და ვალდებულების შესრულების მოსათხოვად სასამართლოში ჩივილამდე.",
    customNotice: "აღწერეთ დოკუმენტი, რომელიც გჭირდებათ — AI თავად განსაზღვრავს დოკუმენტის ტიპს და საქართველოს კანონმდებლობით სავალდებულო ელემენტებს.",
    cardTitle: "დოკუმენტის ტიპი და დეტალები",
    cardSubtitle: "აირჩიეთ ტიპი და შეავსეთ დეტალები",
    docTypeLabel: "დოკუმენტის ტიპი",
    extraLabel: "დამატებითი დეტალები",
    extraPlaceholder: "დაამატეთ ნებისმიერი სხვა მნიშვნელოვანი დეტალი",
    customExtraLabel: "აღწერეთ საჭირო დოკუმენტი",
    customExtraPlaceholder: "დეტალურად აღწერეთ, რა დოკუმენტი გჭირდებათ და რა პირობები უნდა ჩაერთოს მასში",
    charCountSuffix: "სიმბოლო",
    missingRequiredPrefix: "შესავსებია:",
    generating: "იქმნება...",
    generateCta: "შექმენით დოკუმენტი",
    streamingPlaceholder: "დოკუმენტი იქმნება...",
    minLengthError: "შეავსეთ მინიმუმ ერთი ველი დეტალური ინფორმაციით",
    personalNumberOption: "პ/ნ",
    idCodeOption: "ს/კ",
    personalNumberLabel: "პირადი ნომერი",
    idCodeLabel: "საიდენტიფიკაციო კოდი",
    genericError: "შეცდომა",
    connectionError: "სერვისთან კავშირი ვერ დამყარდა",
    successToast: "დოკუმენტი შეიქმნა",
    resultEmptyHint: "შეავსეთ დეტალები და დააჭირეთ „შექმენით დოკუმენტი”",
    ...
    templateAlertGenerateAnyway: "შექმენით ახალი დოკუმენტი",
  ...
  templatesPage: {
    ...
    pageSubtitle: "შეავსეთ ველები — დოკუმენტი მზადდება მყისიერად, AI-ს გარეშე",
    cardTitle: "შაბლონის ტიპი და დეტალები",
    cardSubtitle: "აირჩიეთ ტიპი და შეავსეთ მონაცემები",
    docTypeLabel: "დოკუმენტის ტიპი",
...
const en: Dict = {
  ...
  documentAnalysis: {
    ...
    subtitle: "AI analyzes risks by category, provides recommendations, and edits your document upon request.",
    disclaimer:
    ...
    dropzoneHint: "Upload a document (PDF, DOCX, TXT, MD, JPG, PNG)",
    pageCreditNotice:
    ...
    unsupportedTypeError: "Unsupported file type — PDF, DOCX, TXT, MD, JPG, or PNG",
    ...
    improveOptionalHint: "If you'd like, AI can help you improve the document.",
    stepContinueToFixCta: "Continue to editing",
    stepFinishCta: "Finish",
  ...
  servicesModal: {
    ...
    templatesHint: "Fill a ready template instantly",
  ...
  generatePage: {
    ...
    demandNotice: "Please note: a legal demand is used to formally assert a claim against a third party and request performance of an obligation before pursuing court action.",
    customNotice: "Describe the document you need — the AI determines the document type and the elements Georgian law requires for it on its own.",
    ...
    customExtraLabel: "Describe the document you need",
    customExtraPlaceholder: "Describe in detail what document you need and what terms it should include",
    ...
    personalNumberOption: "P/N",
    idCodeOption: "S/C",
    personalNumberLabel: "Personal number",
    idCodeLabel: "Identification code",
    genericError: "Error",
