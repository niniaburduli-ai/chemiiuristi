...
export const KEYWORDS_KA = [
  ...
  "რისკების ანალიზი",
  "მანქანის ჯარიმები",
  "მანქანის ჯარიმის გასაჩივრება",
  "რისი უფლება მაქვს",
  // guide topics — high-intent long-tail matched to actual site content
...
export const KEYWORDS_EN = [
  ...
  // services
  "legal consultation",
  "free legal consultation Georgia",
  "contract review",
  "contract generation",
  "contract template Georgia",
  "AI lawyer",
  "AI attorney",
  "legal advice",
  "legal templates",
  ...
  "risk analysis",
  "traffic fines",
  "traffic fine appeal Georgia",
  "know your rights",
  "online lawyer",
  "legal documents",
  // guide topics — high-intent long-tail matched to actual site content
  "apartment rental agreement Georgia",
  "lease agreement Georgia",
  "employment contract Georgia",
  "employee rights Georgia",
  "divorce in Georgia",
  "divorce procedure Georgia",
  "inheritance in Georgia",
  "void contract Georgia",
 ...
 * `/guides/<slug>` is a dynamic route family (every guide is bilingual) so it's
 * matched by prefix here, same as middleware.ts's EN_BILINGUAL_PATHS handling —
 * keep the two in sync.
 */
export function localizedPath(path: string, locale: Locale): string {
  if (locale !== "en") return path
  if (path.startsWith("/guides/")) return enPath(path)
