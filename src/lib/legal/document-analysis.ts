...
- findings ასახავდეს შესწორებული ტექსტის დარჩენილ რისკებს, მხოლოდ იმ შემთხვევაში, თუ რისკი პრინციპში შესწორებადია ხელშეკრულების ტექსტში ცვლილებით. ყოველი ასეთი, ტექსტით შესწორებადი რისკი — მიუხედავად სირთულისა — აუცილებლად გამოასწორე "revisedText"-ში; კრიტიკული ან მაღალი სირთულის რისკის გამოტოვება დაუშვებელია.
- თუ რისკი სისტემური/გარეშე ხასიათისაა და ვერ გამოსწორდება მხოლოდ ხელშეკრულების ტექსტის ჩასწორებით (მაგ. პლატფორმის/მესამე მხარის ინჰერენტული რისკი, კანონის თავისი ხარვეზი, ან სხვა ისეთი ფაქტორი, რომლის მოსაგვარებლად ტექსტის რედაქტირება არ არის ადეკვატური ინსტრუმენტი) — ის არასოდეს დააბრუნო "findings" მასივში, როგორც შეუსწორებელი ხელშეკრულების ხარვეზი. ამის ნაცვლად ჩაწერე ის "recommendations" მასივში, მკაფიოდ განმარტებული კონტექსტით, რომ მომხმარებელს ესმოდეს, რატომ არ ჩაერთო ეს ხელშეკრულების ტექსტში.
- თუ ყველა ტექსტით შესწორებადი რისკი გამოსწორდა, "findings" დააბრუნე ცარიელი მასივით — მასში არასოდეს მოხვდეს ისეთი შენიშვნა, რომლის მოგვარებაც არ არის ტექსტის ცვლილების ფარგლებში შესაძლებელი.
- "explanation" ველი დაწერე მაქსიმუმ 1-2 მოკლე წინადადებით (დაახლოებით 25 სიტყვამდე) — მხოლოდ მთავარი პრობლემა და მისი შედეგი, ზედმეტი კონტექსტის გარეშე.
- category და severity მნიშვნელობები ზუსტად ზემოთ ჩამოთვლილთაგან უნდა იყოს, სხვა მნიშვნელობა დაუშვებელია.
- უპასუხე ქართულ ენაზე, მხოლოდ JSON ობიექტით — არც ერთი დამატებითი სიტყვა ჯსონის გარეთ.`;
