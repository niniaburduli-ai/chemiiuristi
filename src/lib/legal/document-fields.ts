...
export const QUESTION_SCHEMAS: Record<string, QuestionField[]> = {
  complaint: [
    { key: "yourName", label: "თქვენი სახელი და გვარი", labelEn: "Your full name", type: "text", required: true },
    partyIdField("your", "თქვენი პირადი ნომერი ან საიდენტიფიკაციო კოდი", "Your personal number or identification code"),
    { key: "yourAddress", label: "თქვენი მისამართი", labelEn: "Your address", type: "text", required: true },
    ...
    { key: "bankAccount", label: "საბანკო ანგარიშის № (თუ გადარიცხვას მოითხოვთ)", labelEn: "Bank account No. (if requesting a transfer)", type: "text" },
  ...
  "debt-claim": [
    ...
    { key: "newDeadline", label: "ახალი ვადა დაფარვისთვის", labelEn: "New deadline for repayment", type: "date", required: true },
    { key: "paymentMethod", label: "გადახდის მეთოდი (ნაღდი/საბანკო გადარიცხვა)", labelEn: "Payment method (cash/bank transfer)", type: "text", required: true },
    { key: "bankAccount", label: "საბანკო ანგარიშის №", labelEn: "Bank account No.", type: "text" },
  ],
  "child-travel-consent": [
    { key: "parentName", label: "მშობლის/წარმომადგენლის სახელი და გვარი", labelEn: "Parent/Representative's full name", type: "text", required: true },
    ...
    { key: "childDocument", label: "არასრულწლოვნის პასპორტის №", labelEn: "Minor's Passport No.", type: "text", required: true },
    { key: "escort", label: "თანმხლები პირი (სახელი, გვარი, პ/ნ. დატოვეთ ცარიელი, თუ მგზავრობს მარტო)", labelEn: "Accompanying person (full name, personal no. Leave blank if traveling alone)", type: "text" },
    { key: "destination", label: "დანიშნულების ქვეყანა/ქვეყნები", labelEn: "Destination country/countries", type: "text", required: true },
    { key: "travelStartDate", label: "გამგზავრების თარიღი", labelEn: "Departure date", type: "date", required: true },
    { key: "travelEndDate", label: "დაბრუნების თარიღი", labelEn: "Return date", type: "date", required: true },
    { key: "otherParentStatus", label: "მეორე მშობლის სტატუსი (მაგ: თანახმაა, გარდაცვლილია, ჩამორთმეული აქვს უფლება)", labelEn: "Other parent's status (e.g., consents, deceased, rights revoked)", type: "textarea", required: true },
  ],
  invoice: [
  ...
  "acceptance-act": [
    ...
    { key: "contractRef", label: "ძირითადი ხელშეკრულების რეკვიზიტები (№ და თარიღი)", labelEn: "Underlying contract details (No. and date)", type: "text" },
    ...
    { key: "currency", label: "ვალუტა", labelEn: "Currency", type: "select", options: ["₾", "$", "€"] },
    { key: "bankAccount", label: "შემსრულებლის/მიმწოდებლის საბანკო ანგარიში (IBAN)", labelEn: "Contractor's/Supplier's Bank Account (IBAN)", type: "text" },
