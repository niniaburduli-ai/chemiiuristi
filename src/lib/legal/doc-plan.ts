...
{"isDocument": true|false, "docTypeKa": "...", "docTypeEn": "...", "checklist": ["...", "..."]}
თუ isDocument არის false, docTypeKa/docTypeEn/checklist დატოვე ცარიელი.`;
...
{"isDocument": true|false, "docTypeKa": "...", "docTypeEn": "...", "checklist": ["...", "..."]}
If isDocument is false, leave docTypeKa/docTypeEn/checklist empty.`;
...
function parsePlan(raw: string): Omit<DocPlan, "costUsd"> | null {
  ...
  return { isDocument, docTypeKa, docTypeEn, checklist };
}
