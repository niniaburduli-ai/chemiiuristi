  ...
  howItWorks: [
    {
      ...
      steps: [
        { text: "გახსენით ჩატი", textEn: "Open the chat" },
        { text: "დაწერეთ თქვენი იურიდიული საკითხი მარტივი ენით", textEn: "Describe your legal question in plain language" },
        { text: "მიიღეთ მყისიერი პასუხი მოქმედი კანონმდებლობის მითითებით", textEn: "Get an instant answer citing current legislation" },
      ],
    ...
    },
    {
      ...
      steps: [
        { text: "ატვირთეთ დოკუმენტი (PDF, DOCX, TXT, MD, JPG, PNG)", textEn: "Upload a document (PDF, DOCX, TXT, MD, JPG, PNG)" },
        { text: "ნახეთ გამოვლენილი რისკები და რეკომენდაციები", textEn: "View identified risks and recommendations" },
        { text: "შეასწორეთ დოკუმენტი თქვენი სურვილისამებრ, AI-ს დახმარებით", textEn: "Edit and improve the document as you wish, powered by AI" },
      ],
    ...
    },
    {
      ...
      steps: [
        { text: "მოძებნეთ ან დაათვალიერეთ შაბლონების ბიბლიოთეკა", textEn: "Search or browse the template library" },
        { text: "შეავსეთ თქვენი მონაცემები და ჩამოტვირთეთ დოკუმენტი", textEn: "Fill in your details and download the document" },
      ],
    ...
    },
    {
      ...
      steps: [
        { text: "აღწერეთ თქვენი სიტუაცია", textEn: "Describe your situation" },
        { text: "AI ადგენს საჩივარს, მოთხოვნას ან ნებისმიერ სხვა დოკუმენტს თქვენს მონაცემებზე დაყრდნობით", textEn: "AI drafts a complaint, demand, or any other document based on your details" },
        { text: "გადახედეთ, მოითხოვეთ შესწორება ან ჩამოტვირთეთ", textEn: "Review it, request a revision, or download" },
      ],
