...
export const GUIDES: Guide[] = [
  {
    ...
    sections: [
      ...
      },
      {
        title: "ვადები",
        paragraphs: [
          "ჯარიმის გასაჩივრებას აქვს კონკრეტული, შეზღუდული ვადა შეტყობინების ჩაბარებიდან — ვადის გაშვების შემთხვევაში საჩივრის განხილვაზე უარი შეიძლება ეთქვას. ვინაიდან ზუსტი ვადა და პროცედურა დროთა განმავლობაში იცვლება, კონკრეტული თარიღების დათვლამდე რეკომენდებულია მიმდინარე რეგულაციის გადამოწმება ან იურისტთან კონსულტაცია.",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        paragraphs: ["შრომითი ხელშეკრულება, ჩვეულებრივ, მოიცავს:"],
        list: [
      ...
      },
      {
        ...
        paragraphs: [
          "დამსაქმებელს შეუძლია დააწესოს გამოსაცდელი ვადა, რომლის განმავლობაშიც შესაძლოა გამარტივებული იყოს ხელშეკრულების შეწყვეტის პირობები. გამოსაცდელი ვადის ხანგრძლივობა და პირობები აუცილებლად უნდა იყოს მითითებული თავად ხელშეკრულებაში — არა მხოლოდ ზეპირად შეთანხმებული.",
        ],
      },
      {
        title: "ძირითადი უფლებები",
        paragraphs: [
          "დასაქმებულს, ზოგადად, აქვს უფლება იცოდეს ხელშეკრულების ყველა პირობა წერილობით, მიიღოს შეთანხმებული ანაზღაურება დათქმულ ვადაში, ისარგებლოს კანონით გათვალისწინებული შვებულებით და დაცული იყოს დაუსაბუთებელი ან უკანონო გათავისუფლებისგან.",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        paragraphs: [
          "ხელშეკრულება, ჩვეულებრივ, ითვლება ბათილად, თუ იგი პირდაპირ ეწინააღმდეგება კანონს ან საზოგადოებრივ ინტერესებს, დადებულია ქმედუუნარო პირთან, ან მისი შინაარსი ფაქტობრივად შეუძლებელია შესასრულებლად. ასეთი ხელშეკრულება არ წარმოშობს სამართლებრივ შედეგებს დამატებითი მოქმედების გარეშეც.",
        ],
      },
      {
